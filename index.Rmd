...
En este ejercicio mostramos las bases del cálculo de similitudes entre comunidades, el cual se convierte en la base de los análisis multivariantes de la comunidad. Específicamente nos interesa;

 * Comprender las bases teóricas para el cálculo de similitudes y distancias en la composición de la comunidad entre localidades.
